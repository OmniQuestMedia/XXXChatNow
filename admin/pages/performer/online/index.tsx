...
import { fromNow } from 'src/lib';

class PerformersOnline extends PureComponent {
  ...
  async search(page = 1, pagination = {}, sorter = {} as any) {
    try {
      ...
      if (sorter) {
        ...
        query.sort = sorter?.order !== 'descend' ? 'asc' : 'desc';
      }
  ...
  render() {
    ...
    const columns = [
      ...
      },
      {
        ...
        render: (lastStreamingTime) => lastStreamingTime && fromNow(lastStreamingTime),
        sorter: true
      },
      {
        title: 'Watching',
...
export default PerformersOnline;
