  ...
  render() {
    return (
      <>
        ...
        <BreadcrumbComponent breadcrumbs={[{ title: 'Static pages', href: '/posts' }, { title: 'Create new post' }]} />
        ...
        <Page>
          ...
          >
            ...
            <Form.Item
              name="canonicalUrl"
              label="Canonical URL"
              help="Custom canonical URL"
            >
              <Input placeholder="Enter custom canonical url" />
            </Form.Item>
            <Form.Item
              name="status"
              label="Status"
