...
export const STREAM_INFORMATION_CHANGED = 'private-stream/streamInformationChanged';
export const STREAM_LEFT = 'private-stream/streamLeft';
export const STREAM_GOAL_CHANNEL = 'STREAM_GOAL_CHANNEL';

export const STREAM_CONTRIBUTE_CHANNEL = 'STREAM_CONTRIBUTE_CHANNEL';
