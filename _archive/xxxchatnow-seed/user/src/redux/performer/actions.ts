import { createAction, createAsyncAction } from 'src/lib/redux';
...
export const updatePerformerStreamingStatus = createAction('UPDATE_PERFORMER_STREAMING_STATUS');
export const updatePerformerStatus = createAction(
  'UPDATE_PERFORMER_STATUS'
);
