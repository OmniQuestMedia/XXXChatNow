...
export class PolicyService implements OnModuleInit {
  ...
  private async seedDefaultPolicies() {
    const defaultPolicies = [
      ...
      {
        key: 'promo_budget_cap_percent',
        value: 0.6,
        description: 'Maximum percentage of membership revenue for promotional budget (60% cap, retaining 40% for OQMI)',
        category: 'campaigns',
        editableBy: ['super_admin', 'finance_admin'],
      },
      {
        key: 'promo_max_bonus_tokens_vip',
        value: 100,
        description: 'Maximum bonus tokens that can be awarded per VIP member during a promotion',
        category: 'campaigns',
        editableBy: ['super_admin', 'campaign_manager'],
      },
      {
        key: 'promo_max_bonus_tokens_gold_vip',
        value: 250,
        description: 'Maximum bonus tokens that can be awarded per Gold VIP member during a promotion',
        category: 'campaigns',
        editableBy: ['super_admin', 'campaign_manager'],
      },
      {
        key: 'promo_max_bonus_tokens_silver_vip',
        value: 150,
        description: 'Maximum bonus tokens that can be awarded per Silver VIP member during a promotion',
        category: 'campaigns',
        editableBy: ['super_admin', 'campaign_manager'],
      },
      {
        key: 'promo_max_bonus_tokens_platinum_vip',
        value: 500,
        description: 'Maximum bonus tokens that can be awarded per Platinum VIP member during a promotion',
        category: 'campaigns',
        editableBy: ['super_admin', 'campaign_manager'],
      },
      {
        key: 'membership_monthly_revenue_vip',
        value: 999,
        description: 'Monthly membership revenue per VIP user (in cents)',
        category: 'pricing',
        editableBy: ['super_admin', 'finance_admin'],
      },
      {
        key: 'membership_monthly_revenue_gold_vip',
        value: 1999,
        description: 'Monthly membership revenue per Gold VIP user (in cents)',
        category: 'pricing',
        editableBy: ['super_admin', 'finance_admin'],
      },
      {
        key: 'membership_monthly_revenue_silver_vip',
        value: 1499,
        description: 'Monthly membership revenue per Silver VIP user (in cents)',
        category: 'pricing',
        editableBy: ['super_admin', 'finance_admin'],
      },
      {
        key: 'membership_monthly_revenue_platinum_vip',
        value: 2999,
        description: 'Monthly membership revenue per Platinum VIP user (in cents)',
        category: 'pricing',
        editableBy: ['super_admin', 'finance_admin'],
      },
    ];
