...
const settings = [
  ...
  },
  {
    ...
    value: `<p style="text-align:center;">
      <strong>${process.env.DOMAIN} © Copyright 2021. All Rights Reserved</strong>
    </p>
    <p style="text-align:center;">
      <img src="https://www.dmca.com/img/dmca_logo.png?=sd" alt="dcma" style="height: 35px;width: 70px;display:inline-block;margin:0 auto"/>
    </p>`,
    name: 'Footer content',
